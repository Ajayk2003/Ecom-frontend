...
export default function UserRegister() {
  ...
  const onSubmitHandler = async data => {
    console.log(data)
    try {
      const response = await fetch('http://localhost:5002/api/auth/register/seller', {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  // No need for `value` and `onChange` with React Hook Form
                />
                {errors.lastName && <span className="text-red-500 text-xs">{errors.description.message}</span>}
              </div>
              <div className="space-y-2">
